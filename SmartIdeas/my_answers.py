...
class NeuralNetwork(object):
    ...
    def __init__(
        ...
        self.weights_input_to_hidden = np.random.normal(0.0,
                self.input_nodes ** -0.5, (self.input_nodes,
                self.hidden_nodes))

        self.weights_hidden_to_output = np.random.normal(0.0,
                self.hidden_nodes ** -0.5, (self.hidden_nodes,
                self.output_nodes))
    ...
    def backpropagation(
        ...
        ### THE HIDDEN ERROR TERM WAS WRONGLY CODED: hidden_error_term = error * self.weights_hidden_to_output
        ...
        delta_weights_h_o += hidden_outputs.reshape(-1, 1) \
            * output_error_term
